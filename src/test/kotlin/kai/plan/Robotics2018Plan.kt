    ...
    fun test() {
        ...
        val actions = arrayOf<Action<Robotics2018WorldState>>(
                Action(
                        ...
                        effect = {
                            it.hasBox = true
                            // TODO: calculate out distance to nearest cube
                            // or to slot
                            it.cost += 5
                            it
                        }),
...
private class Robotics2018WorldState(
        ...
        cost: Float = 0f
) : BaseWorldState<Robotics2018WorldState>(parentState, parentAction, cost), Comparable<Robotics2018WorldState>, World<Robotics2018WorldState> {
