...
fun getManhattanDistance(x1: Int, y1: Int, z1: Int, x2: Int, y2: Int, z2: Int): Int = (abs(x1 - x2) + abs(y1 - y2) + abs(z1 - z2))


fun getChebyshevDistance(pos1: Vec3, pos2: Vec3): Int = getChebyshevDistance(pos1.x, pos1.y, pos1.z, pos2.x, pos2.y, pos2.z)

fun getChebyshevDistance(x1: Int, y1: Int, z1: Int, x2: Int, y2: Int, z2: Int): Int = max(max(abs(x1 - x2), abs(y1 - y2)), abs(z1 - z2))
...
fun getEuclideanDistance(x1: Double, y1: Double, z1: Double, x2: Double, y2: Double, z2: Double): Double = sqrt((x1 - x2).pow(2.0) + (y1 - y2).pow(2.0) + (z1 - z2).pow(2.0))